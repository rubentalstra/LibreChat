  ...
  return (
    <>
      ...
      <input
        ...
        className="border-token-border-medium mb-2 h-9 w-full resize-none overflow-y-auto rounded-lg border px-3 py-2 text-sm outline-hidden focus:ring-2 focus:ring-blue-400 dark:bg-gray-600"
  ...
  return (
    <>
      ...
      <input
        ...
        type="password"
        autoComplete="off"
        className="border-token-border-medium mb-2 h-9 w-full resize-none overflow-y-auto rounded-lg border px-3 py-2 text-sm outline-hidden focus:ring-2 focus:ring-blue-400 dark:bg-gray-800"
